...
const startLeaveProcessingJobs = () => {
  ...
  // Quarterly: 1st of Jan, Apr, Jul, Oct at 01:00 IST
  // Order inside job: approve pending comp-offs → approve pending leaves → credit leaves
  registerJob('quarterly-leave-processing', '0 1 1 1,4,7,10 *', runQuarterlyProcessing, {
    frequency: 'quarterly',
    maxRetries: 3,
  });

  // Half-yearly: 1st of Jan and Jul at 01:30 IST (same pending flush before credit)
