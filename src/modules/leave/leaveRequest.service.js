...
const { getDateOnly, formatDateOnly, formatDateTimeIST } = require('../../utils/time');
  ...
  return (approvals || [])
    .map((a) => {
      ...
      return {
        ...
        actedAt: plain.actedAt ? formatDateTimeIST(plain.actedAt) : null,
...
const formatLeave = (l) => {
  ...
  return {
    ...
    appliedOn: l.appliedOn ? formatDateTimeIST(l.appliedOn) : null,
    ...
    approvedAt:
      l.status === 'approved'
        ? formatDateTimeIST(l.approvedAt || approvedEntry?.actedAt) || null
        : null,
    approvedComment:
    ...
    cancelledAt: l.cancelledAt ? formatDateTimeIST(l.cancelledAt) : null,
    cancelledReason: l.cancelledReason || null,
    createdBy: formatId(l.createdBy),
    createdAt: l.createdAt ? formatDateTimeIST(l.createdAt) : null,
    updatedAt: l.updatedAt ? formatDateTimeIST(l.updatedAt) : null,
  };
};
