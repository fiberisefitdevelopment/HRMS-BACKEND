...
const { getDateOnly, minutesToTimeString, formatDateOnly, formatDateTimeIST, formatTimeIST } = require('../../utils/time');
...
const formatCompOff = (doc) => {
  ...
  return {
    ...
    shiftEndTime: doc.shiftEndTime ? formatDateTimeIST(doc.shiftEndTime) : null,
    punchOutAt: doc.punchOutAt ? formatDateTimeIST(doc.punchOutAt) : null,
...
const getEligibility = async (userId, companyId, date) => {
  ...
  return {
    ...
    shiftEndTime: ctx.shiftEndTime ? formatDateTimeIST(ctx.shiftEndTime) : null,
