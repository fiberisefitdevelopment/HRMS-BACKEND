...
const config = {
  ...
  mail: {
    host: process.env.BREVO_SMTP_HOST || process.env.MAIL_HOST || 'smtp-relay.brevo.com',
    port: parseInt(process.env.BREVO_SMTP_PORT || process.env.MAIL_PORT, 10) || 587,
    user: process.env.BREVO_SMTP_USER || process.env.MAIL_USER || '',
    password: process.env.BREVO_SMTP_KEY || process.env.MAIL_PASSWORD || '',
    from: process.env.MAIL_FROM || process.env.BREVO_SMTP_USER || 'developer@fiberisefit.com',
    fromName: process.env.MAIL_FROM_NAME || process.env.APP_NAME || 'HRMS',
  },
  ...
  auth: {
    ...
    otpExpiresMinutes: parseInt(process.env.PASSWORD_OTP_EXPIRES_MINUTES, 10) || 10,
    otpLength: parseInt(process.env.PASSWORD_OTP_LENGTH, 10) || 6,
    otpMaxAttempts: parseInt(process.env.PASSWORD_OTP_MAX_ATTEMPTS, 10) || 5,
  },
